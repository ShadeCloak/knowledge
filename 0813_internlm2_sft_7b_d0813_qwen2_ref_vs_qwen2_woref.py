...
#######################################################################
# Model
pretrained_model_name_or_path = '/home/rqn/xtuner/Shanghai_AI_Laboratory/internlm2-chat-1_8b'
...
max_epochs = 1
optim_type = AdamW
lr = 5e-07  # refer to alignment handbook
betas = (0.9, 0.999)
weight_decay = 0
...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        data_files=[
            '/home/rqn/ANAH/anah/training_sample2.jsonl',
        ]),
    tokenizer=tokenizer,
